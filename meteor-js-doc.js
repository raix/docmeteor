...
if (packageFolder) {
  ...
  var prependJS = 'var exportObject = { npmDepend: [] }, Npm = {depends: exportObject.npmDepend.push }; Package = {describe: function(obj) {exportObject.describe = obj;},on_use: function(fn) {exportObject.on_use = fn;},onUse: function(fn) {exportObject.onUse = fn;},on_test: function(fn) {exportObject.on_test = fn;},onTest: function(fn) {exportObject.onTest = fn;}};\n';
  var appendJS = '\nmodule.exports = exportObject;';

  var homepath = process.env.HOME || process.env.HOMEPATH || process.env.USERPROFILE;

  var destinationFilename = path.join(homepath, '.codepackage.js');
